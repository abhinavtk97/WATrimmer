package abhi.tk.com.wavidtrim.activity;
...
import abhi.tk.com.wavidtrim.R;
            ...
            public void onClick(View v) {
                ...
                if (selectedVideoUri != null) {
                  //  videoView.pause();
                    ...
                    Snackbar.make(mainlayout, "Please select a video", 4000).show();
            }
        });
                       ...
                       // rangeSeekBar.setSelectedMaxValue(duration);
                        ...
                        rangeSeekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
                            ...
                            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                                ...
                                tvLeft.setText(getTime((int) seekBar.getProgress()));

                                tvRight.setText(getTime((int) seekBar.getProgress()));
                            }
...
//                }
    ...
    private void executeCutVideoCommand() {
        ...
        metadataRetriever.setDataSource(yourRealPath);
        ...
        int fileNo=0;
            ...
            while (leng > 30) {
                ...
                fileNo = 0;
                dest = new File(moviesDir, filePrefix + fileNo + counterr + fileExtn);
                while (dest.exists()) {
                    fileNo++;
                    dest = new File(moviesDir, filePrefix  + fileNo + counterr + fileExtn);
                }
                Log.d(TAG, "startTrim: dest: " + dest.getAbsolutePath());
                 ...
                 Log.d(TAG, "startTrim: endMs: " + startMs+30);
                filePath = dest.getAbsolutePath();
                String[] complexCommand = {"-ss", "" + startMs, "-y", "-i", yourRealPath, "-t", "30", "-s", h+"x"+w , "-vcodec", "mpeg4", "-b:v", "2097152", "-b:a", "48000", "-ac", "2", "-ar", "22050", filePath};
        ...
        Log.d(TAG, "startTrim: dest: " + dest.getAbsolutePath());
        Log.d(TAG, "startTrim: startMs: " + startMs);
        Log.d(TAG, "startTrim: endMs: " + startMs+leng);}
        else
            Snackbar.make(mainlayout, "Selected video is already less than 30 seconds", 4000).show();
        ...
        try {
            ffmpeg.execute(command, new ExecuteBinaryResponseHandler() {
                ...
                public void onProgress(String s) {
                    ...
                    progressDialog.setMessage("Part "+String.valueOf(counterr)+"\n"+s);
                    progressDialog.show();
                }
